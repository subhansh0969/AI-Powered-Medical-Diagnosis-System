...
background_image_url = "https://cdn.pixabay.com/photo/2020/03/08/23/23/coronavirus-4914026_1280.jpg"
...
models = {
    'diabetes': pickle.load(open(r"D:\project data\Medical diagnosis using AI\Models/diabetes_model.sav", 'rb')),
    'heart_disease': pickle.load(open(r"D:\project data\Medical diagnosis using AI\Models\heart_disease_model.sav", 'rb')),
    'parkinsons': pickle.load(open(r"D:\project data\Medical diagnosis using AI\Models/parkinsons_model.sav", 'rb')),
    'lung_cancer': pickle.load(open(r"D:\project data\Medical diagnosis using AI\Models/lungs_disease_model.sav", 'rb')),
    'thyroid': pickle.load(open(r"D:\project data\Medical diagnosis using AI\Models/Thyroid_model.sav", 'rb'))
}
...
if selected == 'Diabetes Prediction':
    ...
    Pregnancies = float(display_input('Number of Pregnancies', 'Enter number of times pregnant', 'Pregnancies', 'number'))
    Glucose = float(display_input('Glucose Level', 'Enter glucose level', 'Glucose', 'number'))
    BloodPressure = float(display_input('Blood Pressure value', 'Enter blood pressure value', 'BloodPressure', 'number'))
    SkinThickness = float(display_input('Skin Thickness value', 'Enter skin thickness value', 'SkinThickness', 'number'))
    Insulin = float(display_input('Insulin Level', 'Enter insulin level', 'Insulin', 'number'))
    BMI = float(display_input('BMI value', 'Enter Body Mass Index value', 'BMI', 'number'))
    DiabetesPedigreeFunction = float(display_input('Diabetes Pedigree Function value', 'Enter diabetes pedigree function value', 'DiabetesPedigreeFunction', 'number'))
    Age = float(display_input('Age of the Person', 'Enter age of the person', 'Age', 'number'))
...
if selected == "Lung Cancer Prediction":
    st.title("Lung Cancer prediction using AI")
...
if selected == "Hypo-Thyroid Prediction":
    st.title("Hypo-Thyroid prediction using AI")
